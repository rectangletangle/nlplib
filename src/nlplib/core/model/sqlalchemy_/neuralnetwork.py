...
from nlplib.core.model.neuralnetwork import NeuralNetwork, Structure, Element, Link, Node, IONode
...
class StructureMapper (ClassMapper) :
    ...
    def mapper_kw (self) :
        ...
        element_table = self.tables['element']

        input_relation = relationship(io_node_class,
                                      primaryjoin=and_(self.table.c.id==element_table.c.structure_id,
                                                       io_node_table.c.is_input),
                                      foreign_keys=element_table.c.structure_id)
    ...
    def mapper_kw (self) :
        ...
        return {'inherits' : self.classes['element'],
                ...
                'properties' : {'input_node'      : input_node_relation,
                                ...
                                '_id'             : column_property(self.table.c.id, self.tables['element'].c.id)}}
